...
Deno.test("rollout: 100% includes all devices", () => {
  ...
  assertEquals(isDeviceInRollout("XYZ78901", "1.5.2", 100), true);
  assertEquals(isDeviceInRollout("00000000", "1.5.2", 100), true);
});

Deno.test("rollout: 0% excludes all devices", () => {
  assertEquals(isDeviceInRollout("A1B2C3D4", "1.5.2", 0), false);
  assertEquals(isDeviceInRollout("XYZ78901", "1.5.2", 0), false);
  assertEquals(isDeviceInRollout("00000000", "1.5.2", 0), false);
});
...
Deno.test("rollout: same input always produces same result", () => {
  ...
  const result3 = isDeviceInRollout("A1B2C3D4", "1.5.2", 50);
