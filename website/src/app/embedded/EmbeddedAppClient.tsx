...
export function EmbeddedAppClient() {
  ...
  const { apiWebexStatus, webexOauthStatus, webexPollIntervalMs, setWebexPollIntervalMs, startWebexOAuth } = useWebexStatus({ appToken, isPaired, addLog });
        ...
        <div className="max-w-2xl mx-auto p-4">
          ...
          {!showSetup && (
            <>
              ...
              {activeTab === 'webex' && <WebexTab appToken={appToken} webexReady={webexReady} displayName={displayName} webexError={webexError} webexOauthStatus={webexOauthStatus} webexPollIntervalMs={webexPollIntervalMs} onWebexPollIntervalChange={setWebexPollIntervalMs} onStartWebexOAuth={startWebexOAuth} />}
