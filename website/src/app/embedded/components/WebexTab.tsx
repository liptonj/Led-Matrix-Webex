...
export const WebexTab = memo(function WebexTab({ appToken, webexReady, displayName, webexError, webexOauthStatus, webexPollIntervalMs, onWebexPollIntervalChange, onStartWebexOAuth }: WebexTabProps) {
  return (
    <Card>
